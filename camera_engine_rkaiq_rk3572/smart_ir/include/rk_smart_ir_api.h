...
#define SMARTIR_VERSION "SMARTIR v2.1.0"
...
typedef enum RK_SMART_IR_STATUS_e {
    ...
    RK_SMART_IR_STATUS_STARLIGHT        = 3,
...
typedef struct rk_smart_ir_lock_s {
    bool lock_en;
    int lock_interval;
} rk_smart_ir_lock_t;
...
typedef struct rk_smart_ir_starlight_s {
    bool mode_en;
    bool mid_trans_en;
    float low_envL_th;
    float high_envL_th;
} rk_smart_ir_starlight_t;
...
typedef struct rk_smart_ir_attr_s {
    ...
    rk_smart_ir_lock_t lock_cfg;
    rk_smart_ir_calib_t calib_cfg;
    rk_smart_ir_starlight_t starlight_cfg;
} rk_smart_ir_attr_t;
