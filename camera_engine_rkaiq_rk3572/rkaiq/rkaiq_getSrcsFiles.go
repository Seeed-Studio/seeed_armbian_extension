...
func rkaiq_getSrcsFiles(soc string, macros_map map[string]bool) []string {
    ...
    srcs = append(srcs, "c_base/aiq_thpool.c")
    // debug
    ...
    if use_newstruct {
        ...
        flag4 = macros_map["ISP_HW_V351s"]
        if flag4 {
            srcs = append(srcs, "modules/rk_aiq_isp351s_modules.c")
        }
...
func rkaiq_getSrcsFiles_c(soc string, macros_map map[string]bool) []string {
    ...
    if (macros_map["RKAIQ_HAVE_AIRMS"]) {
        srcs = append(srcs, "hwi_c/aiq_AiRmsStreamProcUnit.c")
    }
    ...
    if (macros_map["RKAIQ_HAVE_MEMC"]) {
        srcs = append(srcs, "hwi_c/rawReprocess/RkAiqMemcManager.c")
    }

    if (macros_map["RKAIQ_HAVE_FPNSW"]) {
        srcs = append(srcs, "hwi_c/rawReprocess/aiq_fpnSwStreamProcUnit.c")
    }
    ...
    if (macros_map["ISP_HW_V35"]) {
        srcs = append(srcs, "hwi_c/rawReprocess/aiq_btnrReproc.c")
        srcs = append(srcs, "hwi_c/isp35/aiq_CamHwIsp35.c")
        srcs = append(srcs, "hwi_c/isp39/aiq_isp39ParamsCvt.c")
        srcs = append(srcs, "hwi_c/isp35/aiq_isp35ParamsCvt.c")
        srcs = append(srcs, "hwi_c/isp35/aiq_isp35ParamsSplitter.c")
    }

    if (macros_map["ISP_HW_V351s"]) {
        srcs = append(srcs, "hwi_c/isp351s/aiq_CamHwIsp351s.c")
        srcs = append(srcs, "hwi_c/isp351s/aiq_isp351sParamsCvt.c")
        srcs = append(srcs, "hwi_c/isp39/aiq_isp39ParamsCvt.c")
        srcs = append(srcs, "hwi_c/isp35/aiq_isp35ParamsCvt.c")
        srcs = append(srcs, "hwi_c/isp35/aiq_isp35ParamsSplitter.c")
    }
    ...
    srcs = append(srcs, "aiq_core_c/aiq_global_3a_info.c")
    ...
    if (macros_map["ISP_HW_V35"]) {
        srcs = append(srcs, "aiq_core_c/aiq_stats_translator_v35.c")
    }

    if (macros_map["ISP_HW_V351s"]) {
        srcs = append(srcs, "aiq_core_c/aiq_stats_translator_v351s.c")
    }
    ...
    if flag0 {
        srcs = append(srcs, "aiq_core_c/algo_handlers/RkAiqHsvHandler.c")
    }
    flag0 = macros_map["RKAIQ_HAVE_ASD_V11"]
    if flag0 {
        srcs = append(srcs, "aiq_core_c/algo_handlers/RkAiqAsdHandler.c")
    }
    flag0 = macros_map["RKAIQ_HAVE_LDCH_V22"]
    if (flag0) {
    ...
    if (macros_map["RKAIQ_HAVE_AIBNR"]) {
        srcs = append(srcs, "aiq_core_c/algo_handlers/RkAiqAibnrHandler.c")
    }

    if (macros_map["RKAIQ_HAVE_AIRMS"]) {
        srcs = append(srcs, "aiq_core_c/algo_handlers/RkAiqAirmsHandler.c")
    }

    if (macros_map["RKAIQ_HAVE_AIYNR"]) {
        srcs = append(srcs, "aiq_core_c/algo_handlers/RkAiqAiynrHandler.c")
    }

    if (macros_map["RKAIQ_HAVE_ASD_V11"]) {
        srcs = append(srcs, "aiq_core_c/algo_handlers/RkAiqAsdHandler.c")
    }
    ...
    srcs = append(srcs, "RkAiynrManager.c")
