...
if (TOOLCHAIN_ARCH STREQUAL "arm")
set(CMAKE_C_FLAGS "-mfloat-abi=softfp -D__clang__ -w -DARMLINUX -D__gnu_linux__ -fPIC" CACHE STRING "Default CFLAGS")
set(CMAKE_CXX_FLAGS "-mfloat-abi=softfp -D__clang__ -w -DARMLINUX -D__gnu_linux__ -fPIC" CACHE STRING "Default CXXFLAGS")
set(CMAKE_EXE_LINKER_FLAGS "" CACHE STRING "Default LDFLAGS for executables")
else(TOOLCHAIN_ARCH STREQUAL "aarch64")
set(CMAKE_C_FLAGS "-D__clang__ -w -DARMLINUX -D__gnu_linux__ -fPIC" CACHE STRING "Default CFLAGS")
set(CMAKE_CXX_FLAGS "-D__clang__ -w -DARMLINUX -D__gnu_linux__ -fPIC" CACHE STRING "Default CXXFLAGS")
set(CMAKE_EXE_LINKER_FLAGS "" CACHE STRING "Default LDFLAGS for executables")
endif()
...
set(CMAKE_SYSROOT "${RELOCATED_HOST_DIR}/${TOOLCHAIN_SYSROOT}")
set(CMAKE_FIND_ROOT_PATH "${RELOCATED_HOST_DIR}/${TOOLCHAIN_SYSROOT}")
set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
set(ENV{PKG_CONFIG_SYSROOT_DIR} "${RELOCATED_HOST_DIR}/${TOOLCHAIN_SYSROOT}")
...
set(CMAKE_STRIP "llvm-strip" CACHE INTERNAL "strip tool")
