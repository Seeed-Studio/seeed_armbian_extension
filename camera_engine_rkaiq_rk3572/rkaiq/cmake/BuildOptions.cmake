...
set(RKAIQ_BUILD_FOR_XOS FALSE CACHE INTERNAL "Build rkaiq for xos")
...
elseif (RKAIQ_TARGET_SOC STREQUAL "rk3576")
    ...
    set(RKAIQ_HAVE_FAKECAM      TRUE)
    option(RKAIQ_HAVE_DUMPSYS "Have dumpsys" ON)
elseif (RKAIQ_TARGET_SOC STREQUAL "rk3572")
    set(RKAIQ_ISP_VERSION        "351s"  CACHE INTERNAL "ISP hardware version 351s"     FORCE)
	set(RKAIQ_NEWSTRUCT_TEST     TRUE)
	set(RKAIQ_IMPLEMENT_C	TRUE)
    set(RKAIQ_HAVE_FAKECAM      TRUE)
    option(RKAIQ_HAVE_DUMPSYS "Have dumpsys" ON)
...
if (RKAIQ_ISP_VERSION STREQUAL "351s")
    ...
    set(RKAIQ_HAVE_AIBNR FALSE  CACHE INTERNAL "Build AIBNR"       FORCE)
    set(RKAIQ_HAVE_AIRMS FALSE  CACHE INTERNAL "Build AIRMS"       FORCE)
    set(RKAIQ_HAVE_AIYNR FALSE  CACHE INTERNAL "Build AIYNR"       FORCE)
...
elseif (RKAIQ_ISP_VERSION STREQUAL "35")
    set(RKAIQ_HAVE_BAYERNR  FALSE CACHE INTERNAL "Build rkaiq's BAYERNR"      FORCE)
    set(RKAIQ_HAVE_BAYER2DNR  FALSE CACHE INTERNAL "Build rkaiq's BAYER2DNR"  FORCE)
    set(RKAIQ_HAVE_DEHAZE   FALSE CACHE INTERNAL "Build rkaiq's DEHAZE"       FORCE)
    set(RKAIQ_HAVE_ENHANCE   TRUE CACHE INTERNAL "Build rkaiq's ENHANCE"       FORCE)
...
if (RKAIQ_ISP_VERSION STREQUAL "351s")
    ...
    set(RKAIQ_HAVE_GIC_V3   FALSE  CACHE INTERNAL "Build rkaiq's GIC version 2"       FORCE)
    set(RKAIQ_HAVE_GIC_V40   TRUE   CACHE INTERNAL "Build rkaiq's GIC version 2"       FORCE)
    ...
    set(RKAIQ_HAVE_BAYERTNR_V42  FALSE  CACHE INTERNAL "Build rkaiq's BAYERTNR version 42"   FORCE)
    set(RKAIQ_HAVE_BAYERTNR_V51  TRUE   CACHE INTERNAL "Build rkaiq's BAYERTNR version 42"   FORCE)
...
elseif (RKAIQ_ISP_VERSION STREQUAL "35")
    ...
    set(RKAIQ_HAVE_GIC_V40   FALSE CACHE INTERNAL "Build rkaiq's GIC version 2"       FORCE)
    set(RKAIQ_HAVE_ORB_V1   FALSE CACHE INTERNAL "Build rkaiq's ORB version 1"       FORCE)
    set(RKAIQ_HAVE_EIS_V1   FALSE CACHE INTERNAL "Build rkaiq's EIS version 1"       FORCE)
    set(RKAIQ_HAVE_CAC_V03  FALSE CACHE INTERNAL "Build rkaiq's CAC version 03"      FORCE)
    set(RKAIQ_HAVE_CAC_V10  FALSE CACHE INTERNAL "Build rkaiq's CAC version 10"      FORCE)
...
if (RKAIQ_BUILD_FOR_XOS)
    set(RKAIQ_HAVE_PDAF FALSE)
    set(RKAIQ_HAVE_LDCH_V10 FALSE)
    set(RKAIQ_HAVE_LDCH_V21 FALSE)
    set(RKAIQ_HAVE_LDCH_V22 FALSE)
    set(RKAIQ_HAVE_FPNSW FALSE)
    set(RKAIQ_HAVE_MEMC FALSE)
endif()
