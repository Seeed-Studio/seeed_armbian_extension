...
func rkaiq_getStaticLibSrcs(name string, macros_map map[string]bool) []string {
    ...
    if (strings.Compare(name, "librkaiq_pdlibsony") == 0) {
        flag0 := macros_map["RKAIQ_HAVE_PDAF"]
        if flag0 {
            srcs = append(srcs, "pdlibsony/PdafLibrary.c")
            srcs = append(srcs, "pdlibsony/PdafMathFunc.c")
        }
        return srcs
    }
...
func rkaiq_getCamgroupStaticLibSrcs(macros_map map[string]bool) []string {
    ...
    if useNewstruct {
        ...
        if (macros_map["RKAIQ_HAVE_3DLUT_V1"]) {
    ...
    flag4 = macros_map["RKAIQ_HAVE_YNR_V40"]
    flag5 = macros_map["RKAIQ_HAVE_YNR_V41"]
    if flag0 {
    ...
    flag4 = macros_map["RKAIQ_HAVE_BAYERTNR_V41"]
    flag5 = macros_map["RKAIQ_HAVE_BAYERTNR_V42"]
    flag6 = macros_map["RKAIQ_HAVE_BAYERTNR_V51"]
    if flag0 {
    ...
    } else if flag3 || flag4 || flag5 || flag6 {
        if useNewstruct {
            srcs = append(srcs, "newStruct/bayertnr/rk_aiq_algo_camgroup_btnr.c")
        } else {
    ...
    flag5 = macros_map["RKAIQ_HAVE_SHARP_V40"]
    flag6 = macros_map["RKAIQ_HAVE_SHARP_V41"]
    if ((flag0 || flag1 || flag4 || flag5 || flag6) && useNewstruct) {
    ...
    flag5 = macros_map["RKAIQ_HAVE_CNR_V35"]
    flag6 = macros_map["RKAIQ_HAVE_CNR_V36"]
    if ((flag0 || flag1 || flag4 || flag5 || flag6) && useNewstruct) {
...
func rkaiq_getNewStructStaticLibSrcs(name string, macros_map map[string]bool) []string {
    ...
    case "librkaiq_bayertnr":
        ...
        flag3 := macros_map["RKAIQ_HAVE_BAYERTNR_V41"]
        flag4 := macros_map["RKAIQ_HAVE_BAYERTNR_V42"]
        flag5 := macros_map["RKAIQ_HAVE_BAYERTNR_V51"]
    ...
    case "librkaiq_cnr":
        ...
        flag3 := macros_map["RKAIQ_HAVE_CNR_V35"]
        flag4 := macros_map["RKAIQ_HAVE_CNR_V36"]
        if flag0 || flag1 || flag2 || flag3 || flag4 {
    ...
    case "librkaiq_gic":
        ...
        flag1 := macros_map["RKAIQ_HAVE_GIC_V3"]
        flag2 := macros_map["RKAIQ_HAVE_GIC_V40"]
        if flag0 || flag1 || flag2 {
    ...
    case "librkaiq_sharp":
        ...
        flag3 := macros_map["RKAIQ_HAVE_SHARP_V40"]
        flag4 := macros_map["RKAIQ_HAVE_SHARP_V41"]
        if flag0 || flag1 || flag2 || flag3 || flag4 {
    ...
    case "librkaiq_ynr":
        ...
        flag2 := macros_map["RKAIQ_HAVE_YNR_V40"]
        flag3 := macros_map["RKAIQ_HAVE_YNR_V41"]
        if flag0 || flag1 || flag2 || flag3 {
    ...
    case "librkaiq_enh":
        {
            flag0 := macros_map["RKAIQ_HAVE_ENHANCE_V10"]
            if flag0 {
                srcs = append(srcs, "enh/algo_enh.c")
            }
            break
        }
    ...
    case "librkaiq_hsv":
        {
            flag0 := macros_map["RKAIQ_HAVE_HSV"]
            if flag0 {
                srcs = append(srcs, "hsv/algo_hsv.c")
            }
            if (len(srcs) != 0 && dumpsys) {
                srcs = append(srcs, "hsv/algo_hsv_info.c")
            }
            break
        }
    ...
    case "librkaiq_asd":
        {
            flag0 := macros_map["RKAIQ_HAVE_ASD_V11"]
            if flag0 {
                srcs = append(srcs, "asd/algo_asd.c")
            }
            break
        }
    ...
    case "librkaiq_aibnr":
        {
            if (macros_map["RKAIQ_HAVE_AIBNR"]) {
                srcs = append(srcs, "aibnr/algo_aibnr.c")
            }
            break
        }
    ...
    case "librkaiq_airms":
        {
            if (macros_map["RKAIQ_HAVE_AIRMS"]) {
                srcs = append(srcs, "airms/algo_airms.c")
            }
            break
        }
    ...
    case "librkaiq_aiynr":
        {
            if (macros_map["RKAIQ_HAVE_AIYNR"]) {
                srcs = append(srcs, "aiynr/algo_aiynr.c")
            }
            break
        }
