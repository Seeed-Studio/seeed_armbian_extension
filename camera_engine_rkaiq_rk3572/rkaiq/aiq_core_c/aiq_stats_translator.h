...
// micro used by lsc gain for FaceAe stats
...
typedef struct faceAeCfg_s {
    bool en;
    ae_faceStatsSrc_mode_t statsSrc;
} faceAeCfg_t;
...
struct AiqStatsTranslator_s {
    ...
    RkAiqIspUniteInfo_t mIspUniteInfo;
...
XCamReturn AiqStatsTranslator_AecMapLscCoef(window_t cur_win, struct isp3x_lsc_cfg lsc_cfg, float* lsc_coef);
