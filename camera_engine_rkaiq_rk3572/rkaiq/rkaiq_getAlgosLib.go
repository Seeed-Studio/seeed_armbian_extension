...
func rkaiq_getAlgosLib(macros_map map[string]bool) []string {
    ...
    if (macros_map["ISP_HW_V35"] || macros_map["ISP_HW_V351s"]) {
        static_lib = append(static_lib, "libautoblc")
    }
    ...
    flag2 = macros_map["RKAIQ_HAVE_GIC_V3"]
    flag3 = macros_map["RKAIQ_HAVE_GIC_V40"]
    if (flag0 || flag1 || flag2 || flag3) {
        if ((flag1 || flag2 || flag3) && useNewstruct) {
    ...
    flag1 = macros_map["RKAIQ_HAVE_YNR_V40"]
    flag2 = macros_map["RKAIQ_HAVE_YNR_V41"]
    ...
    flag1 = macros_map["RKAIQ_HAVE_CNR_V35"]
    flag2 = macros_map["RKAIQ_HAVE_CNR_V36"]
    if (flag0 || flag1 || flag2) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_cnr")
        } else {
    ...
    flag1 = macros_map["RKAIQ_HAVE_SHARP_V40"]
    flag2 = macros_map["RKAIQ_HAVE_SHARP_V41"]
    if (flag0 || flag1 || flag2) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_sharp")
        } else {
    ...
    flag1 = macros_map["RKAIQ_HAVE_BAYERTNR_V41"]
    flag2 = macros_map["RKAIQ_HAVE_BAYERTNR_V42"]
    flag3 = macros_map["RKAIQ_HAVE_BAYERTNR_V51"]
    if (flag0 || flag1 || flag2 || flag3) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_bayertnr")
        } else {
    ...
    if (flag0) {
        ...
        static_lib = append(static_lib, "librkaiq_pdlibsony")
    }
    ...
    if (macros_map["RKAIQ_HAVE_HISTEQ_V10"]) {
        static_lib = append(static_lib, "librkaiq_histeq")
    }

    if (macros_map["RKAIQ_HAVE_ENHANCE_V10"]) {
        static_lib = append(static_lib, "librkaiq_enh")
    }

    if (macros_map["RKAIQ_HAVE_HSV"]) {
        static_lib = append(static_lib, "librkaiq_hsv")
    }
    ...
    if (macros_map["RKAIQ_HAVE_AIBNR"]) {
        static_lib = append(static_lib, "librkaiq_aibnr")
    }

    if (macros_map["RKAIQ_HAVE_AIRMS"]) {
        static_lib = append(static_lib, "librkaiq_airms")
    }

    if (macros_map["RKAIQ_HAVE_AIYNR"]) {
        static_lib = append(static_lib, "librkaiq_aiynr")
    }
    ...
    if (macros_map["ISP_HW_V35"] || macros_map["ISP_HW_V351s"]) {
        if (macros_map["RKAIQ_HAVE_FPNSW"]) {
            static_lib = append(static_lib, "libfpn_correction")
        }

        if (macros_map["RKAIQ_HAVE_MEMC"]) {
            static_lib = append(static_lib, "libgyro_memc")
        }
    }
