...
// clang-format off
    ...
    // { &g_RkIspAlgoDescAe.common,            RK_AIQ_CORE_ANALYZE_AE,     0, 6, 0,    {grp_conds_array_info(aeGrpCondV3x)}      },
#else
...
#endif
#if RKAIQ_HAVE_AIBNR
    { &g_RkIspAlgoDescAibnr.common,         RK_AIQ_CORE_ANALYZE_GRP0,    0,  1,  0, {grp_conds_array_info(grp0Cond)}          },
#endif
...
#endif
#if RKAIQ_HAVE_GIC_V3 || RKAIQ_HAVE_GIC_V40
    ...
    { &g_RkIspAlgoDescHisteq.common,          RK_AIQ_CORE_ANALYZE_GRP0,   0, 1, 0,    {grp_conds_array_info(grp0Cond)}         },
#endif
#if RKAIQ_HAVE_ENHANCE_V10
    { &g_RkIspAlgoDescEnh.common,          RK_AIQ_CORE_ANALYZE_GRP0,   0, 1, 0,    {grp_conds_array_info(grp0Cond)}         },
#endif
#if RKAIQ_HAVE_HSV_V11
    { &g_RkIspAlgoDescHsv.common,          RK_AIQ_CORE_ANALYZE_GRP1,   0, 0, 0,    {grp_conds_array_info(grp0Cond)}         },
#endif
#if (RKAIQ_HAVE_SHARP_V41)
    { &g_RkIspAlgoDescSharp.common,           RK_AIQ_CORE_ANALYZE_GRP0,   0, 1, 0,       {grp_conds_array_info(grp0Cond)}          },
#endif
#if (RKAIQ_HAVE_BAYERTNR_V42) || defined(RKAIQ_HAVE_BAYERTNR_V51)
    ...
    { &g_RkIspAlgoDescAsd.common,         RK_AIQ_CORE_ANALYZE_OTHER,    0,  1,  0, {grp_conds_array_info(otherGrpCondV3x)}          },
#endif
#endif
...
#endif
#if RKAIQ_HAVE_AIRMS
    { &g_RkIspAlgoDescAirms.common,         RK_AIQ_CORE_ANALYZE_GRP0,    0,  1,  0, {grp_conds_array_info(grp0Cond)}          },
#endif
#if RKAIQ_HAVE_AIYNR
    { &g_RkIspAlgoDescAiynr.common,         RK_AIQ_CORE_ANALYZE_GRP0,    0,  1,  0, {grp_conds_array_info(grp0Cond)}          },
#endif
