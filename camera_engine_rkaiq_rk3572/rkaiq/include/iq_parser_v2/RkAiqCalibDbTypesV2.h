...
#endif
#ifdef ISP_HW_V351s
#include "iq_parser_v2/RkAiqCalibDbV2TypesIsp351s.h"
#endif
...
typedef struct CamCalibDbV2Tuning_s {
    ...
    CamCalibDbV2ContextIsp351s_t calib_scene;
#else
...
#elif defined(ISP_HW_V351s)
    CamCalibDbV2ContextIsp351s_t scene_isp351s;
#else
#error "WRONG ISP_HW_VERSION, ONLY SUPPORT V20 AND V21 AND V30 NOW !"
#endif
...
typedef struct CamCalibDbProj_s {
    ...
    // M4_STRUCT_DESC("ProductInfo", "normal_ui_style")
    CalibDbProductInfo_t product_info;
