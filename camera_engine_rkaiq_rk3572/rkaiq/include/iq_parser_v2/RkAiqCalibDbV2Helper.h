...
#define CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(nm) \
    CALIB_MODULE_RELATIVE_OFFSET(CamCalibDbV2ContextIsp351s_t, nm)

#if defined(ISP_HW_V351s)
static calibdb_ctx_member_offset_info_t info_CamCalibDbV2ContextIsp351s_t[] = {
    {"ae_calib", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(ae_calib)},
    {"wb", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(wb)},
    {"blc", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(blc)},
    {"demosaic", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(demosaic)},
    {"colorAsGrey", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(colorAsGrey)},
    {"ccm", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(ccm)},
    {"dpc", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(dpc)},
    {"ie", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(ie)},
    {"cp", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(cp)},
    {"mge", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(mge)},
    {"drc", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(drc)},
    {"trans", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(trans)},
    {"lsc", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(lsc)},
    {"bayertnr", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(bayertnr)},
    {"texEst", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(texEst)},
    {"ynr", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(ynr)},
    {"sharp", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(sharp)},
    {"cnr", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(cnr)},
    {"gamma", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(gamma)},
    {"enh", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(enh)},
    {"hsv", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(hsv)},
    {"gic", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(gic)},
    {"histEQ", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(histEQ)},
    {"cac", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(cac)},
    {"gain", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(gain)},
    {"csm", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(csm)},
    {"cgc", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(cgc)},
    {"ldc", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(ldc)},
    {"af_calib", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(af_calib)},
    {"fpnSw", CALIBV2_MODULE_RELATIVE_OFFSET_ISP351s(fpnSw)},
    {NULL, 0},
};
#endif
...
#endif
#if defined(ISP_HW_V351s)
    {351, info_CamCalibDbV2ContextIsp351s_t},
#endif
};
...
#endif
#ifdef ISP_HW_V351s
    return sizeof(CamCalibDbV2ContextIsp351s_t);
#endif
    return 0;
}
...
#endif
#ifdef ISP_HW_V351s
    return "CamCalibDbV2ContextIsp351s_t";
#endif
    return NULL;
}
...
calibdbv2_get_scene_ptr(CamCalibSubSceneList_t* scene) {
    ...
    if (CHECK_ISP_HW_V351s())
        return (&scene->scene_isp351s);
#else
    return NULL;
#endif
    return NULL;
...
#elif defined(ISP_HW_V351s)
    memcpy(&dst->calib_scene, src->calib_scene,
           sizeof(CamCalibDbV2ContextIsp351s_t));
#else
...
static calibdb_ctx_member_offset_info_t info_CamCalibDbSenceCis_t[] = {
    ...
    {"CisWb", CALIB_MODULE_RELATIVE_OFFSET_CIS(cis_wb)},
    {NULL, 0},
};
