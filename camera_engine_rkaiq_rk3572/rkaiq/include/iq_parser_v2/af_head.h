...
typedef struct CalibDbV2_Af_PdafResolution_s {
    ...
    // M4_NUMBER_DESC("imageCropX", "u16", M4_RANGE(0, 65535), "0", M4_DIGIT(0))
    unsigned short imageCropX;
    // M4_NUMBER_DESC("imageCropY", "u16", M4_RANGE(0, 65535), "0", M4_DIGIT(0))
    unsigned short imageCropY;
    // M4_NUMBER_DESC("imageBaseWidth", "u16", M4_RANGE(0, 65535), "4096", M4_DIGIT(0))
    unsigned short imageBaseWidth;
    // M4_NUMBER_DESC("imageBaseHeight", "u16", M4_RANGE(0, 65535), "3072", M4_DIGIT(0))
    unsigned short imageBaseHeight;
    // M4_NUMBER_DESC("pdOffsetX", "u16", M4_RANGE(0, 65535), "0", M4_DIGIT(0))
    unsigned short pdOffsetX;
    // M4_NUMBER_DESC("pdOffsetY", "u16", M4_RANGE(0, 65535), "0", M4_DIGIT(0))
    unsigned short pdOffsetY;
    // M4_NUMBER_DESC("pdDensityVal", "u32", M4_RANGE(0, 65535), "0", M4_DIGIT(0))
    unsigned long pdDensityVal;
...
typedef struct CalibDbV2_Af_PdafFaceAf_s {
    ...
    // M4_NUMBER_DESC("pdFaceAfConvergedThred", "u16", M4_RANGE(0, 1023), "12", M4_DIGIT(0))
    unsigned short pdFaceAfConvergedThred;
    // M4_NUMBER_DESC("pdFaceAfDefocusThred", "u16", M4_RANGE(0, 1023), "24", M4_DIGIT(0))
    unsigned short pdFaceAfDefocusThred;
    // M4_BOOL_DESC("pdFaceRoiExtEn", "0")
    bool pdFaceRoiExtEn;
    // M4_NUMBER_DESC("pdFaceRoiLeftExtRatio", "f32", M4_RANGE(-5,5), "0", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceRoiLeftExtRatio;
    // M4_NUMBER_DESC("pdFaceRoiRightExtRatio", "f32", M4_RANGE(-5,5), "0", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceRoiRightExtRatio;
    // M4_NUMBER_DESC("pdFaceRoiTopExtRatio", "f32", M4_RANGE(-5,5), "0", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceRoiTopExtRatio;
    // M4_NUMBER_DESC("pdFaceRoiBottomExtRatio", "f32", M4_RANGE(-5,5), "0", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceRoiBottomExtRatio;
    // M4_BOOL_DESC("pdBlendWithCentorRoiEn", "0")
    bool pdBlendWithCentorRoiEn;
} CalibDbV2_Af_PdafFaceAf_t;

typedef enum  {
    CalibDbV2_FIXED_GRID_WIN_16_12,
    CalibDbV2_FIXED_GRID_WIN_8_6
} CalibDbV2PdafType1WinMode;

typedef enum {
    CalibDbV2_RAW10_CONF11_PD11,
    CalibDbV2_RAW10_CONF11_PD10,
    CalibDbV2_RAW10_CONF8_PD10,
    CalibDbV2_STATS_CUSTOM
} CalibDbV2PdafType1StatsFormat;

#define PDAF_TYPE1_CONFID_DOT_NUM    16

typedef struct CalibDbV2_Af_PdafGainConfid_s {
    // M4_NUMBER_DESC("pdNoiseSn", "f32", M4_RANGE(1,512), "1", M4_DIGIT(3),M4_HIDE(0))
    float                       analogGain;
    // M4_NUMBER_DESC("confidence", "u32", M4_RANGE(0, 4095), "1024", M4_DIGIT(0))
    unsigned int                confidence;
} CalibDbV2_Af_PdafGainConfid_t;

typedef struct CalibDbV2_Af_PdafType1_s {
    // M4_STRUCT_LIST_DESC("pdafGainConfid", M4_SIZE(1,16), "normal_ui_style")
    CalibDbV2_Af_PdafGainConfid_t pdafGainConfid[PDAF_TYPE1_CONFID_DOT_NUM];
    // M4_NUMBER_DESC("pdafGainConfid_len", "s32", M4_RANGE(1,16), "1", M4_DIGIT(0), M4_HIDE(0))
    int                         pdafGainConfid_len;
    // M4_NUMBER_DESC("defocusBitShift", "u32", M4_RANGE(0, 32), "14", M4_DIGIT(0))
    int                         defocusBitShift;
    // M4_ENUM_DESC("sensorPDStatsFormat", "CalibDbV2PdafType1StatsFormat", "CalibDbV2_RAW10_CONF11_PD11")
    CalibDbV2PdafType1StatsFormat  sensorPDStatsFormat;
    // M4_ENUM_DESC("sensorPDWinMode", "CalibDbV2PdafType1WinMode", "CalibDbV2_FIXED_GRID_WIN_16_12")
    CalibDbV2PdafType1WinMode      sensorPDWinMode;
    // M4_BOOL_DESC("searchPeripheryEn", "0")
    bool                           searchPeripheryEn;
} CalibDbV2_Af_PdafType1_t;
...
typedef struct CalibDbV2_Af_Pdaf_s {
    ...
    // M4_STRUCT_DESC("pdType1", "normal_ui_style")
	CalibDbV2_Af_PdafType1_t pdType1;
} CalibDbV2_Af_Pdaf_t;
...
typedef struct Af_PdafResolution_s {
	...
	/* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(3),
        M4_NOTES(Start x position of current setting.\n
        Freq of use: high))  */
    unsigned short ImageCropX;
    /* M4_GENERIC_DESC(
        M4_ALIAS(ImageCrop_y),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,65535),
        M4_DEFAULT(0),
        ...
        M4_RO(0),
        M4_ORDER(4),
        M4_NOTES(Start y position of current setting.\n
        Freq of use: high))  */
    unsigned short ImageCropY;
    /* M4_GENERIC_DESC(
        M4_ALIAS(ImageBaseWidth),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,65535),
        M4_DEFAULT(4096),
        ...
        M4_RO(0),
        M4_ORDER(5),
        M4_NOTES(Image width of sensor before crop.\n
        Freq of use: high))  */
    unsigned short ImageBaseWidth;
    /* M4_GENERIC_DESC(
        M4_ALIAS(ImageBaseHeight),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,65535),
        M4_DEFAULT(3072),
        ...
        M4_RO(0),
        M4_ORDER(6),
        M4_NOTES(Image height of sensor before crop.\n
        Freq of use: high))  */
    unsigned short ImageBaseHeight;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdOffsetX),
        ...
        M4_RO(0),
        M4_ORDER(7),
        M4_NOTES(Pd data start x position of current setting.\n
        Freq of use: high))  */
    unsigned short PdOffsetX;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdOffsetY),
        ...
        M4_RO(0),
        M4_ORDER(8),
        M4_NOTES(Pd data start y position of current setting.\n
        Freq of use: high))  */
    unsigned short PdOffsetY;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdDensityVal),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,65535),
        M4_DEFAULT(2304),
...
typedef struct Af_PdafFaceAf_s {
    ...
    unsigned char PdFaceAfInRoiBlkVerNum;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfConvergedThred),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1023),
        M4_DEFAULT(12),
        ...
        M4_RO(0),
        M4_ORDER(7),
        M4_NOTES(Converged threshold to stop search.\n
        Freq of use: high))  */
    unsigned short PdFaceAfConvergedThred;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfDefocusThred),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1023),
        M4_DEFAULT(24),
        ...
        M4_RO(0),
        M4_ORDER(8),
        M4_NOTES(Defocus motor position threshold to start search.\n
        Freq of use: high))  */
    unsigned short PdFaceAfDefocusThred;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceRoiExtEn),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(9),
        M4_NOTES(Enable pdaf roi extend function.\n
        Freq of use: high))  */
    bool PdFaceRoiExtEn;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceRoiLeftExtRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        M4_RO(0),
        M4_ORDER(10),
        M4_NOTES(Face roi left extend ratio.\n
        Freq of use: high))  */
    float PdFaceRoiLeftExtRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceRoiRightExtRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        M4_RO(0),
        M4_ORDER(11),
        M4_NOTES(Face roi right extend ratio.\n
        Freq of use: high))  */
    float PdFaceRoiRightExtRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceRoiTopExtRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        M4_RO(0),
        M4_ORDER(12),
        M4_NOTES(Face roi top extend ratio.\n
        Freq of use: high))  */
    float PdFaceRoiTopExtRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceRoiBottomExtRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        M4_RO(0),
        M4_ORDER(13),
        M4_NOTES(Face roi bottom extend ratio.\n
        Freq of use: high))  */
    float PdFaceRoiBottomExtRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdBlendWithCentorRoiEn),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(14),
        M4_NOTES(Enable blend with centor roi function.\n
        Freq of use: high))  */
    bool PdBlendWithCentorRoiEn;
} Af_PdafFaceAf_t;

typedef struct Af_PdafGainConfid_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(analogGain),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(Image sensor analog gain.\n
        Freq of use: high))  */
    float                       AnalogGain;
    /* M4_GENERIC_DESC(
        M4_ALIAS(confidence),
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(Confidence Level Threshold.\n
        Freq of use: high))  */
    unsigned int                Confidence;
} Af_PdafGainConfid_t;

typedef struct Af_PdafType1_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdafGainConfid),
        M4_TYPE(struct_list),
        M4_SIZE_EX(1,16),
        M4_UI_MODULE(normal_ui_style),
        M4_HIDE_EX(0),
        ...
        M4_DYNAMIC_EX(1),
        M4_ORDER(0),
        M4_NOTES(Gain confidence table.\n
        Freq of use: high))  */
    Af_PdafGainConfid_t         PdafGainConfid[PDAF_TYPE1_CONFID_DOT_NUM];
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdafGainConfid_len),
        M4_TYPE(u32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(1,16),
        M4_DEFAULT(1),
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(Length of gain confidence table.\n
        Freq of use: high))  */
    int                         PdafGainConfid_len;
    /* M4_GENERIC_DESC(
        M4_ALIAS(DefocusBitShift),
        M4_TYPE(u32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,32),
        M4_DEFAULT(14),
        ...
        M4_RO(0),
        M4_ORDER(2),
        M4_NOTES(Defocus bit shift of final type1 pdlib output.\n
        Freq of use: low))  */
    int                         DefocusBitShift;
    /* M4_GENERIC_DESC(
        M4_ALIAS(SensorPDStatsFormat),
        M4_TYPE(enum),
        M4_ENUM_DEF(CalibDbV2PdafType1StatsFormat),
        M4_DEFAULT(CalibDbV2_RAW10_CONF11_PD11),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(3),
        M4_NOTES(pd stats format of pdaf type1.\n
        Freq of use: low))  */
    CalibDbV2PdafType1StatsFormat  SensorPDStatsFormat;
    /* M4_GENERIC_DESC(
        M4_ALIAS(SensorPDWinMode),
        M4_TYPE(enum),
        M4_ENUM_DEF(CalibDbV2PdafType1WinMode),
        M4_DEFAULT(CalibDbV2_FIXED_GRID_WIN_16_12),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(4),
        M4_NOTES(Windows mode of pdaf type1.\n
        Freq of use: low))  */
    CalibDbV2PdafType1WinMode      SensorPDWinMode;
    /* M4_GENERIC_DESC(
        M4_ALIAS(SearchPeripheryEn),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(5),
        M4_NOTES(Enable search periphery roi when centor roi failed.\n
        Freq of use: low))  */
    bool                           SearchPeripheryEn;
} Af_PdafType1_t;
