...
#elif defined(ISP_HW_V39) || defined(ISP_HW_V33) || defined(ISP_HW_V35) || defined(ISP_HW_V351s)
typedef struct __aiq_measure_info {
    // M4_STRUCT_DESC("ae_hwstats", "normal_ui_style")
    uapi_ae_v39_hwstats_t ae_hwstats;
    // M4_STRUCT_DESC("wb_log", "normal_ui_style")
    uapi_wbV32_log_t wb_log;
#if ISP_HW_V39 || ISP_HW_V35 || ISP_HW_V351s
    // M4_STRUCT_DESC("af_hwstats", "normal_ui_style")
...
#if defined(ISP_HW_V20) || defined(ISP_HW_V21) || defined(ISP_HW_V30) || defined(ISP_HW_V32) || defined(ISP_HW_V32_LITE) || defined(ISP_HW_V39) || defined(ISP_HW_V35) || defined(ISP_HW_V351s)
