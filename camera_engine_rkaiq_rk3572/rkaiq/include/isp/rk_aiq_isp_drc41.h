...
typedef struct drc_preProc_dyn_s {
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_ORDER(2),
        M4_NOTES(Users can
       directly configure the tone curve through toneCurveCtrl when toneCurve_mode ==
       drc_cfgCurveCtrlCoeff_mode.\n Freq of use: high))  */
	...
	/* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(Users can config the weight of the brightest channel among RGB when calculating the Y channel luma.
                Freq of use: low))  */
	...
	/* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(Users can config the weight of the medium brightness channel among RGB when calculating the Y channel luma.
                Freq of use: low))  */
	...
	/* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(Users can config the weight of the darkest channel among RGB when calculating the Y channel luma.
                Freq of use: low))  */
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(The soft thread in calculating the Y channel luma.
                Freq of use: low))  */
