...
#ifdef ISP_HW_V351s
#include "rk_aiq_isp_common_cisgain.h"
#define BLC_ISO_SEGMENT_MAX                     13
#endif
...
typedef struct blc_obcPreTnr_dynCIS_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obR_offset),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_b_fixed
    int16_t hw_blcC_obR_offset;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obGr_offset),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_a_fixed
    int16_t hw_blcC_obGr_offset;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obGb_offset),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_d_fixed
    int16_t hw_blcC_obGb_offset;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obB_offset),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_c_fixed
    int16_t hw_blcC_obB_offset;
} blc_obcPreTnr_dynCIS_t;
...
typedef struct blc_params_dyn_s {
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_ORDER(0),
        M4_NOTES(The dynamic params of optical black correction before TNR.))  */
    blc_obcPreTnr_dynCIS_t obcPreTnr;
#endif
    /* M4_GENERIC_DESC(
        M4_ALIAS(obcPostTnr),
        M4_TYPE(struct),
...
#ifdef ISP_HW_V351s
typedef struct blc_obMean_dyn_s{
	/* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obMeanR_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_b_fixed
    int16_t hw_blcC_obMeanR_val;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obMeanGr_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_a_fixed
    int16_t hw_blcC_obMeanGr_val;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obMeanGb_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_d_fixed
    int16_t hw_blcC_obMeanGb_val;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obMeanB_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-4096,4095),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_bls_c_fixed
    int16_t hw_blcC_obMeanB_val;
}blc_obMean_dyn_t;

typedef struct blc_obSigma_dyn_s{
	/* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obSigmaR_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,511),
        M4_DEFAULT(0),
        ...
        It is is recommended to be calibrated and generated\n
        Freq of use: high))  */
    //reg: sw_isp_ob_offset
    int16_t hw_blcC_obSigmaR_val;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obSigmaGr_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,511),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_isp_ob_offset
    int16_t hw_blcC_obSigmaGr_val;
	 /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obSigmaGb_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,511),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_isp_ob_offset
    int16_t hw_blcC_obSigmaGb_val;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_blcC_obSigmaB_val),
        M4_TYPE(s16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,511),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    //reg: sw_isp_ob_offset
    int16_t hw_blcC_obSigmaB_val;
}blc_obSigma_dyn_t;


typedef struct blc_calib_dyn_s {
	 /* M4_GENERIC_DESC(
        M4_ALIAS(obMean_Dyn),
        M4_TYPE(struct),
        M4_UI_MODULE(blc_curve_ui),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The static params of demosaic module))  */
	blc_obMean_dyn_t obMean;
	 /* M4_GENERIC_DESC(
        M4_ALIAS(obSigma_dyn),
        M4_TYPE(struct),
        M4_UI_MODULE(blc_curve_ui),
        M4_HIDE_EX(0),
        M4_RO(0),
...
typedef struct blc_param_s {
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(calibDyn),
        M4_TYPE(struct),
        M4_UI_MODULE(blc_calib_ui),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The static params of demosaic module))  */
    blc_calib_dyn_t calibDyn;
#endif
    /* M4_GENERIC_DESC(
        M4_ALIAS(dyn),
        M4_TYPE(struct),
