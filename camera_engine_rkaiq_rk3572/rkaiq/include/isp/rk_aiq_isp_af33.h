...
typedef struct af_pdafResolution_s {
    ...
    /* M4_GENERIC_DESC(
        ...
        Freq of use: high))  */
    unsigned short sw_afT_imageCrop_x;
    /* M4_GENERIC_DESC(
        ...
        Freq of use: high))  */
    unsigned short sw_afT_imageCrop_y;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_image_width),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        ...
        M4_RO(0),
        M4_ORDER(5),
        M4_NOTES(Image width of sensor input before crop.\n
        Freq of use: high))  */
    unsigned short sw_afT_imageBase_width;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_image_height),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        ...
        M4_RO(0),
        M4_ORDER(6),
        M4_NOTES(Image height of sensor input before crop.\n
        Freq of use: high))  */
    unsigned short sw_afT_imageBase_height;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdCrop_x),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        ...
        Freq of use: high))  */
    unsigned short sw_afT_pdOffset_x;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdCrop_y),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        ...
        Freq of use: high))  */
    unsigned short sw_afT_pdOffset_y;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdDensity_val),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,65535),
        M4_DEFAULT(2304),
        ...
        Freq of use: high))  */
    unsigned long sw_afT_pdDensity_val;
    /* M4_GENERIC_DESC(
...
typedef struct af_pdafFaceAf_s {
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdFaceAfConverged_thred),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1023),
        M4_DEFAULT(12),
        ...
        Freq of use: high))  */
    unsigned short sw_afT_pdFaceAfConverged_thred;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdFaceAfDefocus_thred),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1023),
        M4_DEFAULT(24),
        ...
        Freq of use: high))  */
    unsigned short sw_afT_pdFaceAfDefocus_thred;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdFaceRoiExt_en),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_HIDE_EX(0),
        M4_RO(0),
        ...
        Freq of use: high))  */
    bool sw_afT_pdFaceRoiExt_en;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdFaceRoiLeftExt_ratio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    float sw_afT_pdFaceRoiLeftExt_ratio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdFaceRoiRightExt_ratio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    float sw_afT_pdFaceRoiRightExt_ratio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdFaceRoiTopExt_ratio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    float sw_afT_pdFaceRoiTopExt_ratio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdFaceRoiBottomExt_ratio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(-5,5),
        M4_DEFAULT(0),
        ...
        Freq of use: high))  */
    float sw_afT_pdFaceRoiBottomExt_ratio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdBlendWithCentorRoi_en),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_HIDE_EX(0),
        M4_RO(0),
        ...
        Freq of use: high))  */
    bool sw_afT_pdBlendWithCentorRoi_en;
} af_pdafFaceAf_t;

typedef enum  {
    pdt1_fixed_grid_win_16_12,
    pdt1_fixed_grid_win_8_6
} af_pdafType1WinMode;

typedef enum {
    pdt1_stats_raw10_conf11_pd11,
    pdt1_stats_raw10_conf11_pd10,
    pdt1_stats_raw10_conf8_pd10,
    pdt1_stats_custom
} af_pdafType1StatsFormat;

#define PDAF_TYPE1_CONFID_DOT_NUM    16
typedef struct af_pdafGainConfid_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_analogGain),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(1,512),
        M4_DEFAULT(1),
        ...
        Freq of use: high))  */
    float                       sw_afT_analogGain;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_confidence),
        M4_TYPE(u32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,4095),
        M4_DEFAULT(1023),
        ...
        Freq of use: high))  */
    unsigned int                sw_afT_confidence;
} af_pdafGainConfid_t;
...
typedef struct af_pdafType1_s {
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdafGainConfid_len),
        M4_TYPE(u32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(1,16),
        M4_DEFAULT(1),
        ...
        Freq of use: high))  */
    int                         sw_afT_pdafGainConfid_len;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_defocusBitShift),
        M4_TYPE(u32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,32),
        M4_DEFAULT(14),
        ...
        Freq of use: low))  */
    int                         sw_afT_defocusBitShift;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_sensorPDStatsFormat),
        M4_TYPE(enum),
        M4_ENUM_DEF(af_pdafType1StatsFormat),
        M4_DEFAULT(pdt1_stats_raw10_conf11_pd11),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(3),
        M4_NOTES(pd stats format of pdaf type1.\n
        Freq of use: low))  */
    af_pdafType1StatsFormat     sw_afT_sensorPDStatsFormat;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_sensorPDWinMode),
        M4_TYPE(enum),
        M4_ENUM_DEF(af_pdafType1WinMode),
        M4_DEFAULT(pdt1_fixed_grid_win_16_12),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(4),
        M4_NOTES(Windows mode of pdaf type1.\n
        Freq of use: low))  */
    af_pdafType1WinMode         sw_afT_sensorPDWinMode;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_afT_pdBlendWithCentorRoi_en),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        ...
        Freq of use: low))  */
    bool                        sw_afT_pdSearchPeriphery_en;
} af_pdafType1_t;
