...
typedef enum ae_faceStatsSrc_mode_e {
    ae_faceStats_subWin_mode = 0, // for isp20,21,30,32,33,35
    ae_faceStats_extraMainWin_mode = 1, //for isp39, without predgain
} ae_faceStatsSrc_mode_t;
...
typedef struct ae_faceMoveCtrl_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceWinMovFilt_cnt),
        M4_TYPE(u8),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,10),
        M4_DEFAULT(10),
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(The frame cnt for filtering face-win .\n
        Freq of use: low))  */
    uint8_t sw_aeT_faceWinMovFilt_cnt;

    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceWinMovProb_th),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.13),
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The threshold for calculating probility of moving face.\n
        Freq of use: low))  */
    float sw_aeT_faceWinMovProb_th;

    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceWinMov_wgt),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.6),
        ...
        M4_RO(0),
        M4_ORDER(2),
        M4_NOTES(The weight of moving-face probility.\n
        Freq of use: high))  */
    float sw_aeT_faceWinMov_wgt;

    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceLvStdFilt_cnt),
        M4_TYPE(u8),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(1,10),
        M4_DEFAULT(8),
        ...
        M4_RO(0),
        M4_ORDER(3),
        M4_NOTES(The frame cnt for filtering std of face luminance.\n
        Freq of use: low))  */
    uint8_t sw_aeT_faceLvStdFilt_cnt;

    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceLvStdProb_th),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.3),
        ...
        M4_RO(0),
        M4_ORDER(4),
        M4_NOTES(The threshold for calculating probility of face luminance.\n
        Freq of use: low))  */
    float sw_aeT_faceLvStdProb_th;

    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceLvStd_wgt),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.4),
        ...
        M4_RO(0),
        M4_ORDER(5),
        M4_NOTES(The weight of face luminance probility .\n
        Freq of use: high))  */
    float sw_aeT_faceLvStd_wgt;
} ae_faceMoveCtrl_t;

typedef struct ae_faceWgtCtrl_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceWgtCtrl_len),
        M4_TYPE(u8),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(1,6),
        M4_DEFAULT(6),
        ...
        M4_NOTES(The actual length of dot used.\n
        Freq of use: high))  */
    uint8_t sw_aeT_faceWgtCtrl_len;
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceSize_dot),
        M4_TYPE(f32),
        M4_SIZE_EX(1,12),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.1),
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The dot of face size.\n
        Freq of use: high))  */
    float sw_aeT_faceSize_dot[AE_ROUTE_DOT_MAX_NUM];
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_faceWgt_dot),
        M4_TYPE(f32),
        M4_SIZE_EX(1,12),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.8),
        ...
        M4_RO(0),
        M4_ORDER(2),
        M4_NOTES(The dot of face weight.\n
        Freq of use: high))  */
    float sw_aeT_faceWgt_dot[AE_ROUTE_DOT_MAX_NUM];
} ae_faceWgtCtrl_t;
...
typedef struct ae_faceAeCtrl_s {
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(sw_aeT_statsSrc_mode),
        M4_TYPE(enum),
        M4_ENUM_DEF(ae_faceStatsSrc_mode_t),
        M4_DEFAULT(ae_faceStats_subWin_mode),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The face stats source.\n
        Freq of use: low))  */
    ae_faceStatsSrc_mode_t sw_aeT_statsSrc_mode;
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(faceWgtCtrl),
        M4_TYPE(struct),
        M4_UI_MODULE(array_table_ui),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(11),
        M4_NOTES(The params for face weight control.))  */
    ae_faceWgtCtrl_t faceWgtCtrl;

    /* M4_GENERIC_DESC(
        M4_ALIAS(faceMovCtrl),
        M4_TYPE(struct),
        M4_UI_MODULE(normal_ui_style),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(12),
        M4_NOTES(The params for moving-face control.))  */
    ae_faceMoveCtrl_t faceMovCtrl;
