...
#ifndef _RK_AIQ_PARAM_BTNR51_H_
#define _RK_AIQ_PARAM_BTNR51_H_
...
typedef struct btnr_sigmaCurve_dyn_s {
    /* M4_GENERIC_DESC(
       M4_ALIAS(hw_btnr_preSpnrLuma2sigma),
       M4_TYPE(struct),
       M4_UI_MODULE(btnr_curve_ui),
       M4_HIDE_EX(0),
       M4_RO(0),
       M4_ORDER(0),
...
typedef struct btnr_param_s {
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(calibDyn),
        M4_TYPE(struct),
        M4_UI_MODULE(btnr_calib_ui),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(TODO))  */
    btnr_calib_dyn_t calibDyn;
    /* M4_GENERIC_DESC(
        M4_ALIAS(mdTnrDyn),
        M4_TYPE(struct),
