...
typedef enum aeStats_srcEntity0_mode_e {
    ...
    */
    aeStats_btnrOutLow_mode = 3,
    /*
    reg: (sw_bnr2ae0_sel == 1) && (sw_aemeas_bnr_be_sel == 1)
    */
    aeStats_btnrBeOutLow_mode = 4,

#elif defined(ISP_HW_V351s)
    /*
    reg: (sw_bnr2ae0_sel == 1) && (sw_rawae_from_vicap == 0)
    */
    aeStats_wb1Out_mode = 3,
    /*
    reg: (sw_bnr2ae0_sel == 1) && (sw_rawae_from_vicap == 0)
    */
    aeStats_wb1OutLow_mode = 4,
#endif
...
typedef struct aeStats_entity0_s {
    /* M4_GENERIC_DESC(
        ...
        M4_DEFAULT(aeStats_entity0_chl0DpcOut_mode),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(..... Reference enum types.\nFreq of use: high))  */
    //reg: sw_rawae0_sel, sw_bnr2ae0_sel, sw_rawae_from_vicap, sw_aemeas_bnr_be_sel
...
typedef enum aeStats_srcEntity3_mode_e {
    /*
    reg: (sw_rawae_sel == 0) && (sw_bnr2aebig_sel == 0)
    */
    aeStats_entity3_chl0DpcOut_mode = 0,
    /*
    reg: (sw_rawae_sel == 1) && (sw_bnr2aebig_sel == 0)
    */
    aeStats_entity3_chl1DpcOut_mode = 1,
    /*
    reg: (sw_rawae_sel == 3)
    */
    aeStats_dmIn_mode = 2,
    ...
    */
    aeStats_btnrOutHigh_mode = 3,
    /*
    reg: (sw_bnr2aebig_sel == 1) && (sw_aemeas_bnr_be_sel == 1)
    */
    aeStats_btnrBeOutHigh_mode = 4,

#elif defined(ISP_HW_V351s)
    /*
    reg: (sw_drc2aebig_sel == 1)
    */
    aeStats_drcOut_mode = 3,
    /*
    reg: (sw_bnr2aebig_sel == 1)
    */
    aeStats_wb1OutHigh_mode = 4,
#endif
...
typedef struct aeStats_entity3_s {
    /* M4_GENERIC_DESC(
        ...
        M4_DEFAULT(aeStats_entity3_chl1DpcOut_mode),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(..... Reference enum types.\nFreq of use: high))  */
    //reg: sw_bnr2aebig_sel, sw_rawae_sel, sw_aemeas_bnr_be_sel, sw_drc2aebig_sel
