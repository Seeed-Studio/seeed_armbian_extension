...
typedef struct ynr_hiNrEPF_dyn_s {
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_hiSpnrFilt_diffOffsetScale),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0, 1.0),
        M4_DEFAULT(0.3),
        ...
        M4_NOTES(TODO.\n
        Freq of use: low))  */
    // reg: hw_ynr_hiSpnrFilt_diffOffsetScale
    float hw_ynrT_diffOffset_scale;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_hiSpnrFiltNoise_limit_en),
        M4_TYPE(bool),
        M4_DEFAULT(1),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP_CTRL(noiseLimit_en_group),
        M4_NOTES(TODO.
        Freq of use: high))  */
    // reg: hw_ynr_hiSpnrFiltNoise_limit_en
    bool hw_ynrT_noiseLimit_en;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_hiSpnrFiltNoise_minLimitScale),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0, 1.0),
        M4_DEFAULT(0.3),
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP(noiseLimit_en_group),
        M4_NOTES(TODO.\n
        Freq of use: low))  */
    // reg: hw_ynr_hiSpnrFiltNoise_minLimitScale
    float hw_ynrT_noiseMinLimit_scale;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_hiSpnrFiltNoise_maxLimitScale),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0, 1.0),
        M4_DEFAULT(0.3),
        ...
        M4_NOTES(TODO.\n
        Freq of use: low))  */
    // reg: hw_ynr_hiSpnrFiltNoise_maxLimitScale
    float hw_ynrT_noiseMaxLimit_scale;
#endif
} ynr_hiNrEPF_dyn_t;
...
#if defined(ISP_HW_V351s)
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_miSpnrFilt_edgeAdjust_en),
        M4_TYPE(bool),
        M4_DEFAULT(1),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP(miNr_en_group),
        M4_GROUP_CTRL(edgeAdjust_en_group),
        M4_NOTES(TODO.
        Freq of use: high))  */
    // reg: hw_ynr_miSpnrFilt_edgeAdjust_en
    bool hw_ynrT_edgeAdjust_en;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_miSpnrFilt_edgeOffset),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0,1.0),
        M4_DEFAULT(0.5),
        ...
        M4_RO(0),
        M4_ORDER(6),
        M4_GROUP(miNr_en_group;edgeAdjust_en_group),
        M4_NOTES(TODO.
        Freq of use: high))  */
    //reg: hw_ynr_miSpnrFilt_edgeOffset
    float hw_ynrT_edgeAdjust_offset;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_miSpnrFilt_edgeScale),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0,1.0),
        M4_DEFAULT(0.5),
        ...
        M4_NOTES(TODO.
        Freq of use: high))  */
    //reg: hw_ynr_miSpnrFilt_edgeScale
    float hw_ynrT_edgeAdjust_scale;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_miSpnr_texAdjust_en),
        M4_TYPE(bool),
        M4_DEFAULT(1),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP(miNr_en_group),
        M4_GROUP_CTRL(texAdjust_en_group),
        M4_NOTES(TODO.
        Freq of use: high))  */
    // reg: hw_ynr_miSpnr_texAdjust_en
    bool hw_ynrT_texAdjust_en;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_miSpnr_texThred),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0,1.0),
        M4_DEFAULT(0.5),
        ...
        M4_RO(0),
        M4_ORDER(6),
        M4_GROUP(miNr_en_group;texAdjust_en_group),
        M4_NOTES(TODO.
        Freq of use: high))  */
    //reg: hw_ynr_miSpnr_texThred
    float hw_ynrT_texAdjust_thred;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_miSpnr_texScale),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0,1.0),
        M4_DEFAULT(0.5),
        ...
        M4_NOTES(TODO.
        Freq of use: high))  */
    //reg: hw_ynr_miSpnr_texScale
    float hw_ynrT_texAdjust_scale;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynr_miSpnr_texMinWeight),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0.0,1.0),
        M4_DEFAULT(0.5),
        ...
        M4_NOTES(TODO.
        Freq of use: high))  */
    //reg: hw_ynr_miSpnr_texMinWeight
    float hw_ynrT_texAdjust_minWgt;
#endif
} ynr_midNr_dyn_t;
