...
#if ISP_HW_V351s
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_gInterpGlobalSharpStrg_en),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(G interpolation global sharp and local sharp en\n
        Freq of use: high))  */
    bool hw_dmT_gInterpGlbSharpStrg_en;
#endif
...
#if ISP_HW_V351s
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_medWgtLpf_coeff),
        M4_TYPE(s8),
        M4_SIZE_EX(1,3),
        M4_RANGE_EX(0,127),
        M4_DEFAULT([64,32,16]),
        ...
        M4_NOTES(The lp filter kernel that used to filt the fusion weight map of color-channel diff plane. Fixed.\n
        Freq of use: low))  */
    int8_t hw_dmT_medWgtLpf_coeff[3];
#endif
    /* M4_GENERIC_DESC(
...
#if ISP_HW_V351s
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_cnrMedFltIndex_min),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,8.0),
        M4_DEFAULT(3.0),
        ...
        M4_ORDER(3),
        M4_GROUP(cnr_flt_group),
        M4_NOTES(Med filter clip range min index.\n
        Higher the value, lower the strength. Freq of use: low))  */
    float hw_dmT_cnrMedFltIndex_min;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_cnrMedFltIndex_max),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,8.0),
        M4_DEFAULT(5),
        ...
        M4_ORDER(3),
        M4_GROUP(cnr_flt_group),
        M4_NOTES(Med filter clip range max index, bigger than min index.\n
        Higher the value, lower the strength. Freq of use: low))  */
    float hw_dmT_cnrMedFltIndex_max;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_cnrMedFltRange_scale),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,2.0),
        M4_DEFAULT(0),
        ...
        M4_ORDER(11),
        M4_GROUP(cnr_flt_group),
        M4_NOTES(Med filter range scale.\n
        Higher the value, lower the strength. Freq of use: high))  */
    float hw_dmT_cnrMedFltRange_scale;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_cnrMedFltWgt_minThred),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,4095),
        M4_DEFAULT(0, 64, 128, 256, 512, 512, 512, 512),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(4),
        M4_GROUP(cnr_flt_group),
        M4_NOTES(Med filter and gaus filter fusion wgt.\n
        Higher the value, lower the strength. Freq of use: low))  */
    uint16_t hw_dmT_cnrMedFltWgt_minThred[RK_DM23_LUMA_POINT_NUM];
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_cnrMedFltWgt_slope),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1.0),
        M4_DEFAULT(0.05),
        ...
        M4_ORDER(5),
        M4_GROUP(cnr_flt_group),
        M4_NOTES(Med filter and gaus filter fusion wgt slope.\n
        Higher the value, higher the strength. Freq of use: low))  */
    float hw_dmT_cnrMedFltWgt_slope;
#endif
    /* M4_GENERIC_DESC(
...
#if ISP_HW_V351s
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_dmT_cnrEdgeNorm_bit),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(8.0,12.0),
        M4_DEFAULT(12.0),
        M4_DIGIT_EX(3),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(13),
        M4_GROUP(cnr_flt_group),
        M4_NOTES(Edge normalization bit, the smaller the value, the bigger the edge.\n
        Higher the value, higher the weight. Freq of use: high))  */
    float hw_dmT_cnrEdgeNorm_bit;
#endif
} dm_cflt_param_dyn_t;
...
#define RK_DM33_FIX_BIT_MED_WGT           12
#define RK_DM33_FIX_BIT_MED_WGT_SLOPE     RK_DM33_FIX_BIT_MED_WGT
#define RK_DM33_FIX_BIT_MED_FLT_RANGE_SCALE 10
