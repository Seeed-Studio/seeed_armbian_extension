...
typedef struct {
	/* M4_GENERIC_DESC(
    M4_ALIAS(hw_histCfg_flt_en),
    M4_GROUP_CTRL(flt_en_group),
    M4_TYPE(bool),
    M4_DEFAULT(1),
    M4_HIDE_EX(0),
    M4_RO(0),
    M4_ORDER(0),
    M4_NOTES(TODO))  */
    // reg: hw_histCfg_flt_en;
    bool hw_histCfg_flt_en;
	/* M4_GENERIC_DESC(
    M4_ALIAS(hw_histCfg_flt_coefMax),
    M4_GROUP(flt_en_group),
    M4_TYPE(f32),
    M4_SIZE_EX(1,1),
    M4_RANGE_EX(0,16),
    M4_DEFAULT(4),
    ...
    M4_ORDER(0),
    M4_NOTES(TODO))  */
    float hw_histCfg_cdfFlt_coefMax;
	/* M4_GENERIC_DESC(
    M4_ALIAS(hw_histCfg_flt_coefMin),
    M4_GROUP(flt_en_group),
    M4_TYPE(f32),
    M4_SIZE_EX(1,1),
    M4_RANGE_EX(0,16),
    ...
    M4_ORDER(0),
    M4_NOTES(TODO))  */
    float hw_histCfg_cdfFlt_coefMin;
	/* M4_GENERIC_DESC(
    M4_ALIAS(hw_histCfg_flt_offset),
    M4_GROUP(flt_en_group),
    M4_TYPE(f32),
    M4_SIZE_EX(1,1),
    M4_RANGE_EX(0,16),
    ...
    M4_ORDER(0),
    M4_NOTES(TODO))  */
    float hw_histCfg_cdfFlt_offset;
	/* M4_GENERIC_DESC(
    M4_ALIAS(hw_histCfg_flt_sigma),
    M4_GROUP(flt_en_group),
    M4_TYPE(f32),
    M4_SIZE_EX(1,1),
    M4_RANGE_EX(0,16),
    ...
    M4_ORDER(0),
    M4_NOTES(TODO))  */
    float hw_histCfg_cdfFlt_sigma;
	/* M4_GENERIC_DESC(
    M4_ALIAS(hw_histCfg_flt_gainMax),
    M4_GROUP(flt_en_group),
    M4_TYPE(f32),
    M4_SIZE_EX(1,1),
    M4_RANGE_EX(0,16),
    ...
    M4_ORDER(0),
    M4_NOTES(TODO))  */
    float hw_histCfg_boost_max;
	/* M4_GENERIC_DESC(
    M4_ALIAS(hw_histCfg_flt_gainMin),
    M4_GROUP(flt_en_group),
    M4_TYPE(f32),
    M4_SIZE_EX(1,1),
    M4_RANGE_EX(0,16),
    ...
    M4_ORDER(0),
    M4_NOTES(TODO))  */
    float hw_histCfg_suppress_min;
} histeq_stats_params_fltCfg_t;
#endif
...
typedef struct {
    ...
    M4_ORDER(2),
    M4_NOTES(TODO))  */
    histeq_stats_params_fltCfg_t statsFltCfg;
#endif
