...
typedef struct Aec_Sensor_exp_offset_s {
    bool valid;
    uint32_t integer[3];
    uint32_t decimal[3];
    uint32_t div_coeff[3];
} Aec_Sensor_exp_offset_t;
...
typedef enum AecHwVersion_e
{
    ...
    | V351s    | big    | -      | -      | big    | -     | 2         | only subwin0, support bnr20bit           | RK3572        |
    */
    AEC_HARDWARE_V20   = 0,
    AEC_HARDWARE_V21   = 1,
    AEC_HARDWARE_V30   = 2,
...
typedef struct AecConfig_s {
    ...
    Aec_Sensor_dcg_ratio_t        lcg_lofic_ratio;
    Aec_Sensor_dcg_ratio_t        lofic_vs_ratio;
    Aec_Sensor_exp_offset_t       exp_offset;
    ...
    rawaebig_meas_cfg_t           OldHwCfg; // especially for faceAe
} AecConfig_t;
/*****************************************************************************/
/**
 *          AeInstanceConfig_t
...
typedef struct AecProcResult_s {
    ...
    bool                          LongFrmMode;
    bool                          IsFaceAe;
    ae_faceStatsSrc_mode_t        FaceStatsSrc;
    float                         LumaDeviation;
