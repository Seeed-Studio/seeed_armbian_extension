...
void active_isp_params_dump_bls_status(void* self, st_string* result) {
    ...
    struct isp351s_isp_params_cfg* params = (struct isp351s_isp_params_cfg*)self;
#else
    return;
#endif
...
static void __dump_awb1_gain(void* self, char* buffer, st_string* result) {
    ...
    struct isp351s_awb_gain_cfg* wb_cfg = &params->others.awb_gain_cfg;
#else
...
#if ISP_HW_V351s
    snprintf(buffer, MAX_LINE_LENGTH, "%-14d%-14d%-14d%-14d", wb_cfg->gain0_r,
             wb_cfg->gain0_gr, wb_cfg->gain0_gb, wb_cfg->gain0_b);
#else
...
#if ISP_HW_V351s
    snprintf(buffer, MAX_LINE_LENGTH, "%-14d%-14d%-14d%-14d", wb_cfg->gain1_r,
             wb_cfg->gain1_gr, wb_cfg->gain1_gb, wb_cfg->gain1_b);
#else
...
#if ISP_HW_V351s
    snprintf(buffer, MAX_LINE_LENGTH, "%-14d%-14d%-14d%-14d", wb_cfg->gain2_r,
             wb_cfg->gain2_gr, wb_cfg->gain2_gb, wb_cfg->gain2_b);
#else
...
void active_isp_params_dump_gic_status(void* self, st_string* result) {
    ...
    struct isp351s_isp_params_cfg* params = (struct isp351s_isp_params_cfg*)self;
    bool en                             = params->module_ens & ISP33_MODULE_GIC;
    struct isp351s_gic_cfg* gic_cfg       = &params->others.gic_cfg;
#else
    return;
#endif
...
#elif defined(ISP_HW_V351s)
    struct isp351s_isp_params_cfg* params = (struct isp351s_isp_params_cfg*)self;
    struct isp351s_debayer_cfg* dm_cfg    = &params->others.debayer_cfg;
#else
    return;
#endif
...
#elif defined(ISP_HW_V351s)
    struct isp351s_isp_params_cfg* params = (struct isp351s_isp_params_cfg*)self;
    struct isp351s_drc_cfg* drc_cfg       = &params->others.drc_cfg;
#else
    return;
#endif
...
#if defined(ISP_HW_V39) || defined(ISP_HW_V351s)
...
#elif defined(ISP_HW_V351s)
    struct isp351s_isp_params_cfg* params = (struct isp351s_isp_params_cfg*)self;
    struct isp351s_bay3d_cfg* bay3d_cfg   = &params->others.bay3d_cfg;
#else
    return;
#endif
...
#elif defined(ISP_HW_V351s)
    memset(buffer, 0, MAX_LINE_LENGTH);
    snprintf(buffer, MAX_LINE_LENGTH, "%-5s%-8s", en ? "Y" : "N",
             bay3d_cfg->bypass_en ? "Y" : "N");
#endif
    aiq_string_printf(result, buffer);
    aiq_string_printf(result, "\n\n");
}
...
#elif defined(ISP_HW_V351s)
    struct isp351s_isp_params_cfg* params = (struct isp351s_isp_params_cfg*)self;
    struct isp351s_ynr_cfg* ynr_cfg       = &params->others.ynr_cfg;
#else
    return;
#endif
...
#elif defined(ISP_HW_V351s)
    struct isp351s_isp_params_cfg* params = (struct isp351s_isp_params_cfg*)self;
    struct isp351s_isp_meas_cfg* meas_cfg     = &params->meas;
#else
    return;
#endif

#if !defined(ISP_HW_V35) && !defined(ISP_HW_V351s) //TODO
