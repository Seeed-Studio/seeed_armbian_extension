...
#include "hwi_c/isp351s/aiq_isp351sParamsSplitter.h"
...
static XCamReturn
Isp351sSplitRawAeParams(AiqIspParamsSplitter_t* pSplit,
                        struct isp351s_rawae_meas_cfg* ori,
                        struct isp351s_rawae_meas_cfg* left,
                        struct isp351s_rawae_meas_cfg* right) {
...
static XCamReturn
Isp351sSplitRawHistParams(AiqIspParamsSplitter_t* pSplit,
...
XCamReturn Isp351sSplitAecParams(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                                 struct isp351s_isp_params_cfg* left,
                                 struct isp351s_isp_params_cfg* right) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;

    // RAWAE
    if (ori->module_cfg_update & ISP35_MODULE_RAWAE0)
        ret = Isp351sSplitRawAeParams(pSplit, &ori->meas.rawae0,
                                    &left->meas.rawae0, &right->meas.rawae0);
    if (ori->module_cfg_update & ISP35_MODULE_RAWAE3)
        ret = Isp351sSplitRawAeParams(pSplit, &ori->meas.rawae3,
                                    &left->meas.rawae3, &right->meas.rawae3);

    // RAWHIST
    if (ori->module_cfg_update & ISP35_MODULE_RAWHIST0)
        ret = Isp351sSplitRawHistParams(
...
static XCamReturn
Isp351sSplitRawAeParamsVertical(AiqIspParamsSplitter_t* pSplit,
                                struct isp351s_rawae_meas_cfg* ori,
                                struct isp351s_rawae_meas_cfg* left,
                                struct isp351s_rawae_meas_cfg* right) {
...
static XCamReturn
Isp351sSplitRawHistParamsVertical(AiqIspParamsSplitter_t* pSplit,
                                  struct isp35_rawhist_meas_cfg* ori,
                                  struct isp35_rawhist_meas_cfg* left,
                                  struct isp35_rawhist_meas_cfg* right) {
...
static XCamReturn Isp351sSplitAecParamsVertical(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                               struct isp351s_isp_params_cfg* left,
                               struct isp351s_isp_params_cfg* right) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
    ...
    // RAWAE
    if (ori->module_cfg_update & ISP35_MODULE_RAWAE0)
        ret = Isp351sSplitRawAeParamsVertical(pSplit, &ori->meas.rawae0,
                                    &left->meas.rawae0, &right->meas.rawae0);
    if (ori->module_cfg_update & ISP35_MODULE_RAWAE3)
        ret = Isp351sSplitRawAeParamsVertical(pSplit, &ori->meas.rawae3,
                                    &left->meas.rawae3, &right->meas.rawae3);

    // RAWHIST
    if (ori->module_cfg_update & ISP35_MODULE_RAWHIST0)
        ret = Isp351sSplitRawHistParamsVertical(
            pSplit, &ori->meas.rawhist0, &left->meas.rawhist0, &right->meas.rawhist0);
    if (ori->module_cfg_update & ISP35_MODULE_RAWHIST3)
        ret = Isp351sSplitRawHistParamsVertical(
            pSplit, &ori->meas.rawhist3, &left->meas.rawhist3, &right->meas.rawhist3);
...
XCamReturn Isp351sSplitAwbParams(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                                 struct isp351s_isp_params_cfg* left,
                                 struct isp351s_isp_params_cfg* right) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
...
XCamReturn Isp351sSplitAwbParamsVertical(AiqIspParamsSplitter_t* pSplit,
                                         struct isp351s_isp_params_cfg* ori,
                                         struct isp351s_isp_params_cfg* left,
                                         struct isp351s_isp_params_cfg* right) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
...
XCamReturn Isp351sSplitAlscParams(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                                  struct isp351s_isp_params_cfg* left,
                                  struct isp351s_isp_params_cfg* right) {
...
XCamReturn Isp351sSplitAlscParamsVertical(AiqIspParamsSplitter_t* pSplit,
                                          struct isp351s_isp_params_cfg* ori,
                                          struct isp351s_isp_params_cfg* left,
                                          struct isp351s_isp_params_cfg* right) {
    struct isp3x_lsc_cfg* lsc_cfg_ori = &ori->others.lsc_cfg;
...
XCamReturn Isp351sSplitAynrParams(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                                  struct isp351s_isp_params_cfg* left,
                                  struct isp351s_isp_params_cfg* right) {
    struct isp351s_ynr_cfg* ynr_cfg_ori = &ori->others.ynr_cfg;
    struct isp351s_ynr_cfg* ynr_cfg_lef = &left->others.ynr_cfg;
    struct isp351s_ynr_cfg* ynr_cfg_rht = &right->others.ynr_cfg;
...
XCamReturn Isp351sSplitAynrParamsVertical(AiqIspParamsSplitter_t* pSplit,
                                          struct isp351s_isp_params_cfg* ori,
                                          struct isp351s_isp_params_cfg* left,
                                          struct isp351s_isp_params_cfg* right) {
    struct isp351s_ynr_cfg* ynr_cfg_ori = &ori->others.ynr_cfg;
...
XCamReturn Isp351sSplitAsharpParams(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                                    struct isp351s_isp_params_cfg* left,
                                    struct isp351s_isp_params_cfg* right) {
...
XCamReturn Isp351sSplitAsharpParamsVertical(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                                            struct isp351s_isp_params_cfg* left,
                                            struct isp351s_isp_params_cfg* right) {
    struct isp35_sharp_cfg* sharp_cfg_ori = &ori->others.sharp_cfg;
    struct isp35_sharp_cfg* sharp_cfg_lef = &left->others.sharp_cfg;
...
XCamReturn Isp351sSplitAfParams(AiqIspParamsSplitter_t* pSplit, struct isp351s_isp_params_cfg* ori,
                                struct isp351s_isp_params_cfg* left,
                                struct isp351s_isp_params_cfg* right) {
...
XCamReturn Isp351sSplitAfParamsVertical(AiqIspParamsSplitter_t* pSplit,
                                        struct isp351s_isp_params_cfg* ori,
                                        struct isp351s_isp_params_cfg* left,
                                        struct isp351s_isp_params_cfg* right) {
    struct isp35_rawaf_meas_cfg org_af      = left->meas.rawaf;
...
XCamReturn Isp351sSplitIspParamsVertical(AiqIspParamsSplitter_t* pSplit,
                                         struct isp351s_isp_params_cfg* ori,
                                         struct isp351s_isp_params_cfg* top,
                                         struct isp351s_isp_params_cfg* bottom) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
    ...
    memcpy(bottom, top, sizeof(struct isp351s_isp_params_cfg));
    ...
    ret = Isp351sSplitAecParamsVertical(pSplit, ori, top, bottom);
    // Should return failure ?
    if (ori->module_cfg_update & ISP35_MODULE_RAWAWB)
        ret = Isp351sSplitAwbParamsVertical(pSplit, ori, top, bottom);
    if (ori->module_cfg_update & ISP35_MODULE_LSC)
        ret = Isp351sSplitAlscParamsVertical(pSplit, ori, top, bottom);
    if (ori->module_cfg_update & ISP35_MODULE_YNR)
        ret = Isp351sSplitAynrParamsVertical(pSplit, ori, top, bottom);
    if (ori->module_cfg_update & ISP35_MODULE_SHARP)
        ret = Isp351sSplitAsharpParamsVertical(pSplit, ori, top, bottom);
    if (ori->module_cfg_update & ISP35_MODULE_RAWAF)
        ret = Isp351sSplitAfParamsVertical(pSplit, ori, top, bottom);
...
XCamReturn Isp351sSplitIspParams(AiqIspParamsSplitter_t* pSplit, void* orig_isp_params,
                                 void* isp_params) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;

    struct isp351s_isp_params_cfg* left_isp_params  = (struct isp351s_isp_params_cfg*)isp_params;
    struct isp351s_isp_params_cfg* right_isp_params = (struct isp351s_isp_params_cfg*)isp_params + 1;
    ...
    // Modules that use the same params for both left and right isp
    // will not need to implent split function
    memcpy(right_isp_params, left_isp_params, sizeof(struct isp351s_isp_params_cfg));

    memcpy(&right_isp_params->others.cac_cfg, &cac_right, sizeof(struct isp33_cac_cfg));
    memcpy(&right_isp_params->others.ldch_cfg, &ldch_right, sizeof(struct isp32_ldch_cfg));

    ret = Isp351sSplitAecParams(pSplit, (struct isp351s_isp_params_cfg*)orig_isp_params,
                              left_isp_params, right_isp_params);
    // Should return failure ?
    if (((struct isp351s_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP35_MODULE_RAWAWB)
        ret = Isp351sSplitAwbParams(pSplit, (struct isp351s_isp_params_cfg*)orig_isp_params,
                                  left_isp_params, right_isp_params);
    if (((struct isp351s_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP35_MODULE_LSC)
        ret = Isp351sSplitAlscParams(pSplit, (struct isp351s_isp_params_cfg*)orig_isp_params,
                                   left_isp_params, right_isp_params);
    if (((struct isp351s_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP35_MODULE_YNR)
        ret = Isp351sSplitAynrParams(pSplit, (struct isp351s_isp_params_cfg*)orig_isp_params,
                                   left_isp_params, right_isp_params);
    if (((struct isp351s_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP35_MODULE_SHARP)
        ret = Isp351sSplitAsharpParams(pSplit, (struct isp351s_isp_params_cfg*)orig_isp_params,
                                     left_isp_params, right_isp_params);
    if (((struct isp351s_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP35_MODULE_RAWAF)
        ret = Isp351sSplitAfParams(pSplit, (struct isp351s_isp_params_cfg*)orig_isp_params,
                                 left_isp_params, right_isp_params);

    if (pSplit->isp_unite_mode_ == RK_AIQ_ISP_UNITE_MODE_FOUR_GRID) {
        struct isp351s_isp_params_cfg* bottom_left_isp_params  = (struct isp351s_isp_params_cfg*)isp_params + 2;
        struct isp351s_isp_params_cfg* bottom_right_isp_params = (struct isp351s_isp_params_cfg*)isp_params + 3;

        struct isp351s_isp_params_cfg tmp_orig_params;
        tmp_orig_params = *left_isp_params;
        ret = Isp351sSplitIspParamsVertical(pSplit, &tmp_orig_params, left_isp_params, bottom_left_isp_params);
        tmp_orig_params = *right_isp_params;
        ret = Isp351sSplitIspParamsVertical(pSplit, &tmp_orig_params, right_isp_params, bottom_right_isp_params);
    }
