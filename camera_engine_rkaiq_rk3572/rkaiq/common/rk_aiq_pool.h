...
typedef SharedItemPool<rk_aiq_pdtype1_params_wrapper_t> RkAiqPdType1ParamsPool;
typedef SharedItemProxy<rk_aiq_pdtype1_params_wrapper_t> RkAiqPdType1ParamsProxy;
...
public:
    ...
    SmartPtr<RkAiqPdType1ParamsProxy>       mPdType1Params;
