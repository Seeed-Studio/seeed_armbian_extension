...
int
FakeSensorHw::get_exp_offset(rk_aiq_sensor_exp_offset_t* exp_offset)
{
...
FakeSensorHw::enqueue_rawbuffer(struct rk_aiq_vbuf *vbuf, bool sync)
{
    ...
    if (exp_val_valid) {
        ...
        exp_param_prx->data()->aecExpInfo.LinearExp.exp_real_params.cis_total_gain = vbuf->buf_info[0].cis_total_gain;
        ...
        exp_param_prx->data()->aecExpInfo.HdrExp[2].exp_real_params.cis_total_gain = vbuf->buf_info[2].cis_total_gain;
        ...
        exp_param_prx->data()->aecExpInfo.HdrExp[1].exp_real_params.cis_total_gain = vbuf->buf_info[1].cis_total_gain;
        ...
        exp_param_prx->data()->aecExpInfo.HdrExp[0].exp_real_params.cis_total_gain = vbuf->buf_info[0].cis_total_gain;
