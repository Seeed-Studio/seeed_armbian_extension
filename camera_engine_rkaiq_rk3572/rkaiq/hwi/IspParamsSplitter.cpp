...
int AlscMatrixScale(float lrate, float rrate,
...
XCamReturn IspParamsSplitter::SplitAlscParams<struct isp3x_isp_params_cfg>(
    ...
    AlscMatrixScale(rate_lef, rate_rht,
...
const IspParamsSplitter::Rectangle& IspParamsSplitter::GetBottomLeftIspRect() const {
    return bottom_left_isp_rect_;
}

const IspParamsSplitter::Rectangle& IspParamsSplitter::GetBottomRightIspRect() const {
...
int AlscMatrixScaleVertical(float trate, float brate,
...
XCamReturn IspParamsSplitter::SplitAlscParamsVertical<struct isp32_isp_params_cfg>(
    ...
    AlscMatrixScaleVertical(rate_top, rate_btm,
                            lsc_cfg_ori->r_data_tbl,
