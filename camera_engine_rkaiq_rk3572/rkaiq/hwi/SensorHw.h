...
public:
    ...
    virtual XCamReturn set_pdType1Params(SmartPtr<RkAiqPdType1ParamsProxy>& pdType1_params) {return XCAM_RETURN_NO_ERROR;}
protected:
...
public:
    ...
    virtual XCamReturn set_pdType1Params(SmartPtr<RkAiqPdType1ParamsProxy>& pdType1_params);
...
protected:
    ...
    int get_exp_offset(rk_aiq_sensor_exp_offset_t* exp_offset);
    ...
    struct rkmodule_pdaf_win_cfg_t _last_pdaf_win;
};
