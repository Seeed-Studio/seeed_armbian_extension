...
typedef XCamReturn (*rk_aiq_extproc_dispatch_cb)(void* dispatch_ctx, AiqHwEvt_t* hwres);
...
typedef struct AiqManager_s {
    ...
    void* mExtProcCtx;
    rk_aiq_extproc_dispatch_cb mExtProcBtnrIirCb;
