    ...
    int aibnr_fixIndex)
{
    ...
    out->dyn.hiNr.epf.hw_ynrT_noiseLimit_en = paut->dyn[inear].hiNr.epf.hw_ynrT_noiseLimit_en;
    out->dyn.hiNr.epf.hw_ynrT_noiseMaxLimit_scale = interpolation_f32(
                paut->dyn[ilow].hiNr.epf.hw_ynrT_noiseMaxLimit_scale, paut->dyn[ihigh].hiNr.epf.hw_ynrT_noiseMaxLimit_scale, ratio);
    out->dyn.hiNr.epf.hw_ynrT_noiseMinLimit_scale = interpolation_f32(
                paut->dyn[ilow].hiNr.epf.hw_ynrT_noiseMinLimit_scale, paut->dyn[ihigh].hiNr.epf.hw_ynrT_noiseMinLimit_scale, ratio);
    out->dyn.hiNr.epf.hw_ynrT_diffOffset_scale = interpolation_f32(
                paut->dyn[ilow].hiNr.epf.hw_ynrT_diffOffset_scale, paut->dyn[ihigh].hiNr.epf.hw_ynrT_diffOffset_scale, ratio);

    out->dyn.midLoNr.mf.hw_ynrT_edgeAdjust_en = paut->dyn[inear].midLoNr.mf.hw_ynrT_edgeAdjust_en;
    out->dyn.midLoNr.mf.hw_ynrT_edgeAdjust_offset = interpolation_f32(
                paut->dyn[ilow].midLoNr.mf.hw_ynrT_edgeAdjust_offset, paut->dyn[ihigh].midLoNr.mf.hw_ynrT_edgeAdjust_offset, ratio);
    out->dyn.midLoNr.mf.hw_ynrT_edgeAdjust_scale = interpolation_f32(
                paut->dyn[ilow].midLoNr.mf.hw_ynrT_edgeAdjust_scale, paut->dyn[ihigh].midLoNr.mf.hw_ynrT_edgeAdjust_scale, ratio);

    out->dyn.midLoNr.mf.hw_ynrT_texAdjust_en = paut->dyn[inear].midLoNr.mf.hw_ynrT_texAdjust_en;
    out->dyn.midLoNr.mf.hw_ynrT_texAdjust_thred = interpolation_f32(
                paut->dyn[ilow].midLoNr.mf.hw_ynrT_texAdjust_thred, paut->dyn[ihigh].midLoNr.mf.hw_ynrT_texAdjust_thred, ratio);
    out->dyn.midLoNr.mf.hw_ynrT_texAdjust_scale = interpolation_f32(
                paut->dyn[ilow].midLoNr.mf.hw_ynrT_texAdjust_scale, paut->dyn[ihigh].midLoNr.mf.hw_ynrT_texAdjust_scale, ratio);
    out->dyn.midLoNr.mf.hw_ynrT_texAdjust_minWgt = interpolation_f32(
                paut->dyn[ilow].midLoNr.mf.hw_ynrT_texAdjust_minWgt, paut->dyn[ihigh].midLoNr.mf.hw_ynrT_texAdjust_minWgt, ratio);
#endif
