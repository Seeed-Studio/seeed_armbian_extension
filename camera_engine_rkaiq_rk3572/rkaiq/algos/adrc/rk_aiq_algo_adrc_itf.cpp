...
processing(const RkAiqAlgoCom* inparams, RkAiqAlgoResCom* outparams)
{
    ...
    if (pAdrcCtx->isCapture) {
        ...
        if(pAdrcCtx->FrameNumber == LINEAR_NUM) {
            ...
            pAdrcCtx->NextData.AEData.SExpo =
                pAdrcParams->com.u.proc.nxtExp->HdrExp[0].exp_real_params.cis_total_gain *
            ...
            pAdrcCtx->NextData.AEData.MExpo =
                pAdrcParams->com.u.proc.nxtExp->HdrExp[1].exp_real_params.cis_total_gain *
            ...
            if (pAdrcCtx->NextData.AEData.SExpo < FLT_EPSILON) {
                pAdrcCtx->NextData.AEData.SExpo =
                    pAdrcParams->com.u.proc.curExp->HdrExp[0].exp_real_params.cis_total_gain *
                ...
                pAdrcCtx->NextData.AEData.MExpo =
                    pAdrcParams->com.u.proc.curExp->HdrExp[1].exp_real_params.cis_total_gain *
            ...
            pAdrcCtx->NextData.AEData.LExpo =
                pAdrcParams->com.u.proc.nxtExp->HdrExp[2].exp_real_params.cis_total_gain *
            ...
            if (pAdrcCtx->NextData.AEData.SExpo < FLT_EPSILON) {
                ...
                pAdrcCtx->NextData.AEData.MExpo =
                    ...
                    pAdrcParams->com.u.proc.curExp->HdrExp[1].exp_real_params.integration_time;
                pAdrcCtx->NextData.AEData.LExpo =
                    pAdrcParams->com.u.proc.curExp->HdrExp[2].exp_real_params.cis_total_gain *
