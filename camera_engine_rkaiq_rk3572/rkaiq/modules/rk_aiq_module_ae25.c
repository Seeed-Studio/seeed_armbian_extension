...
static void convertAiqAeToIsp39Params(isp_params_t* isp_params, aeStats_cfg_t* ae_meas)
{
    ...
    if (ae_meas->sw_aeCfg_stats_en) {
        ...
        if (ae_meas->hw_aeCfg_entityGroup_mode == aeStats_entity03_coWk_mode) {
            ...
            isp_params->isp_cfg->meas.rawae0.rawae_sel = ISP39_BNR2AE0_SEL_EN;
            ...
            } else if (ae_meas->entityGroup.entities.entity0.hw_aeCfg_statsSrc_mode == aeStats_wb1Out_mode) {
                isp_params->isp_cfg->meas.rawae0.bnr2ae_sel = 1;
                //isp_params->isp_cfg->meas.rawae0.bnr_be_sel = 1;
                isp_params->isp_cfg->meas.rawae0.wb1_sel_mode = 0x3;

            } else if (ae_meas->entityGroup.entities.entity0.hw_aeCfg_statsSrc_mode == aeStats_wb1OutLow_mode) {
                isp_params->isp_cfg->meas.rawae0.bnr2ae_sel = 1;
                //isp_params->isp_cfg->meas.rawae0.bnr_be_sel = 1;
            }
        ...
        if (ae_meas->hw_aeCfg_entityGroup_mode == aeStats_entity03_coWk_mode) {
            ...
            isp_params->isp_cfg->meas.rawae3.rawae_sel = ISP39_BNR2AEBIG_SEL_EN;
            ...
            } else if (ae_meas->entityGroup.entities.entity3.hw_aeCfg_statsSrc_mode == aeStats_drcOut_mode) {
                isp_params->isp_cfg->meas.rawae3.rawae_sel = 3;
                isp_params->isp_cfg->meas.rawae3.drc2aebig_sel = 1;

            } else if (ae_meas->entityGroup.entities.entity3.hw_aeCfg_statsSrc_mode == aeStats_wb1OutHigh_mode) {
    ...
    LOGD_CAMHW_SUBM(0xff, "isp_cfg: win size: [%dx%d]-[%dx%d] [%dx%d]-[%dx%d]\n",
...
static void convertAiqHistToIsp39Params(isp_params_t* isp_params, const aeStats_cfg_t *ae_meas)
{
    ...
    LOGD_CAMHW_SUBM(0xff, "isp_cfg: hist win size: [%dx%d]-[%dx%d] [%dx%d]-[%dx%d]\n",
