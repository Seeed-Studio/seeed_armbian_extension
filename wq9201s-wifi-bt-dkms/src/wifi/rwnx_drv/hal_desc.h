...
#define AMPDU_OFT 21
/// aMPDU bit
#define AMPDU_BIT BIT(AMPDU_OFT)
...
/**
 * struct rwnx_mgmt_frame_status - cfg80211_ops::mgmt_tx,
 * Management frame send status
 *
 * @frame_nb: mgmt frame sequence number.
 * @ack: mgmt frame has been acknowledged by peer
 */
struct rwnx_mgmt_frame_status {
	u16 frame_nb;
	bool ack;
};

/**
 * struct eapol_m4_tx_status - cfg80211_ops::eapol_m4_tx,
 * Eapol m4 send status
 *
 * @ack: eapol m4 frame has been acknowledged by peer
 */
struct eapol_m4_tx_status {
	bool ack;
};
...
#define MDM_NSS2_MASK ((u32)0x00010200)
